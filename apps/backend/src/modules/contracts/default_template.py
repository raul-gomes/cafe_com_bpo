...
DEFAULT_TEMPLATE_SECTIONS: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "content": (
            ...
            "Escopo e Níveis de Serviço, nas frequências, volumes e valores ali "
    ...
    },
    {
        ...
        "content": (
            ...
            "{{prazo_atendimento_horas}} horas úteis. Os volumes, valores e frequências "
            "de cada serviço constam do Anexo I.\n\n"
            "PARÁGRAFO ÚNICO\n"
    ...
    },
    {
        ...
        "content": (
            ...
            "4.2. Entregar os relatórios e demais produtos previstos no Anexo I, "
            "pelo sistema de gestão, por e-mail ou por portal "
            "web.\n\n"
    ...
    },
    {
        ...
        "content": (
            ...
            "Serviços recorrentes incluídos na mensalidade, com frequência e valor, "
            "conforme a Proposta Comercial:\n\n"
            "| SERVIÇO | FREQUÊNCIA | VALOR |\n"
            "|---|---|---|\n"
            "{% for s in servicos %}"
            "| {{s.nome}} | {{s.frequencia}} | {{s.valor}} |\n"
            "{% if s.descricao %}"
            "| {{s.descricao}} | | |\n"
            "{% endif %}"
            "{% endfor %}\n\n"
