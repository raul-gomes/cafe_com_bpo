...
class PricingCalculator:
    ...
    def calculate_service_cost(
        ...
        total_minutes = service.minutes_per_execution * Decimal(
            str(service.monthly_quantity)
        )
    ...
    def calculate_final_price(pricing_input: PricingInput) -> PricingResult:
        ...
        """
        cost_per_hour = PricingCalculator.calculate_cost_per_hour(
            pricing_input.operation
        )
        cost_per_minute = PricingCalculator.calculate_cost_per_minute(
            pricing_input.operation
        )
        ...
        tax_amount = PricingCalculator.calculate_tax_amount(
            price_before_tax, pricing_input.operation.tax_rate
        )
