...
def upgrade() -> None:
    ...
    op.add_column("users", sa.Column("company_razao_social", sa.String(255), nullable=True))
    op.add_column("users", sa.Column("company_nome_fantasia", sa.String(255), nullable=True))
    ...
    op.add_column("users", sa.Column("company_professional_email", sa.String(255), nullable=True))
    op.add_column("users", sa.Column("company_commercial_phone", sa.String(50), nullable=True))
    op.add_column("users", sa.Column("company_logo_url", sa.String(500), nullable=True))
    op.add_column("users", sa.Column("company_color_code", sa.String(10), nullable=True))
