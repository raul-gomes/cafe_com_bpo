...
class User(Base):
    ...
    company_street = Column(String(255), nullable=True)
    company_number = Column(String(20), nullable=True)
    company_complement = Column(String(255), nullable=True)
    company_neighborhood = Column(String(100), nullable=True)
    company_city = Column(String(100), nullable=True)
    company_state = Column(String(50), nullable=True)
    company_cep = Column(String(20), nullable=True)
