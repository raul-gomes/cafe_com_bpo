...
class TestNotificationSchemas:
    ...
    def test_notification_create_schema(self):
        ...
        schema = NotificationCreate(
            title="Test", message="Test message", type="task_deadline"
        )
...
class TestNotificationAPI:
    ...
    def test_mark_notification_as_read(self, client):
        ...
        resp = client.post(
            "/notifications/",
            json={"title": "Test", "message": "Test message", "type": "system"},
            headers=auth,
        )
    ...
    def test_cannot_access_other_user_notifications(self, client):
        ...
        client.post(
            "/notifications/",
            json={"title": "Private", "message": "Secret message", "type": "system"},
            headers=auth1,
        )
